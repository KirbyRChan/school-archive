...
public class P4A4_CHAN_4212452
{
    public static void main(String[] args) throws FileNotFoundException
    {
        ...
        //Makes a word list object and adds the word from the text file to the list
        P4A4_CHAN_4212452_WordList wordList = new P4A4_CHAN_4212452_WordList();
        wordList.addWordsFromFile("P4A4_CHAN_4212452.txt");
        ...
        do
        {
            ...
            password = wordList.getRandomWord(); //Sets word to a string variable
            
            for (int i = 0; i < password.length(); i++) //Assigns password to character arrays for the actual answer and the user's answer
            {
            ...
            do
            {
                ...
                System.out.print("\nGuess a letter or word: "); //Prompts the user to enter a guess
                guess = kbd.nextLine();
                ...
                {
                    if (password.equals(guess.toLowerCase()) == false) //User guesses incorrectly
                    {
                        //Bomb color changes
                        incorrect++;
                        Bomb(incorrect);
